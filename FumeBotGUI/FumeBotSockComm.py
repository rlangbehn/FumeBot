...
class SockComm(QtCore.QObject):
    ...
    def __init__(self, host='localhost', port=5000, type=DATA_TYPE):
        ...
        self.sock_thread = Thread(target=self.read_from_sock_thread,
                                  args=(self.run_type,))  # The run mode is also passed
        ...
        while self.sock_thread_run is True:
            ...
            try:
                ...
                if start_marker != -1 and end_marker != -1:
                    data_bytes = self.string_bytes[
                                 start_marker + 1:end_marker]  # The start and end markers are stripped
